...
<!--            <h5 class="mt-2">Media heading</h5>-->
        ...
        <button class="btn btn-success btn-sm collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" style="margin:10px; padding:10px 120px;font-size:20px;"> Register <i class="material-icons"></i>
        
        </button>
          <button id="firstevent" class="btn btn-info btn-sm collapsed" type="button" data-toggle="collapse"  style="margin:10px; padding:10px 85px;font-size:20px;">
          Participants List <i class="fa fa-arrow-circle-right fa-lg"></i> 
        </button>
        <button id="firstevent" class="btn btn-danger btn-sm collapsed" type="button" data-toggle="collapse"  style="margin:10px; padding:10px 100px;font-size:20px;">
          Close Event <i class="fa fa-times"></i> 
        </button>
...
<!--            <h5 class="mt-2">Media heading</h5>-->
        ...
        <button class="btn btn-info btn-sm collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="margin:10px; padding:10px 120px;font-size:20px;">  More <i class="fa fa-info-circle fa-lg" aria-hidden="true"></i>
        
        </button><button class="btn btn-success btn-sm collapsed" type="button" data-toggle="collapse"  style="margin:10px; padding:10px 100px;font-size:20px;">
